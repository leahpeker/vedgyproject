...
class ListingForm extends ConsumerStatefulWidget {
  const ListingForm({super.key, this.initial});
  ...
  void initState() {
    ...
    if (l != null) {
      ...
      _fs = _fs.copyWith(
        ...
        listerRelationship: l.listerRelationship.isEmpty
            ? null
            : l.listerRelationship,
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              buildFormDropdown<String>(
                label: 'City *',
                value: _fs.city,
                items: listingCities.map((c) => (c, c)).toList(),
                onChanged: (v) {
                  setState(() {
              ...
              if (_fs.city == 'New York') ...[
                ...
                buildFormDropdown<String>(
                  label: 'Borough *',
                  value: _fs.borough,
                  items: listingBoroughs.map((b) => (b, b)).toList(),
                  onChanged: (v) {
              ...
              buildFormDropdown<String>(
                ...
                items: listingVeganHouseholds.toList(),
                onChanged: (v) {
              ...
              Row(
                children: [
                  Expanded(
                    child: buildFormDropdown<String>(
                      label: 'Rental Type *',
                      value: _fs.rentalType,
                      items: listingRentalTypes.toList(),
                      onChanged: (v) {
              ...
              buildFormDropdown<String>(
                ...
                value: _fs.furnished,
                items: listingFurnishedOptions.toList(),
                onChanged: (v) {
              ...
              buildFormDropdown<String>(
                ...
                items: listingRelationships.toList(),
                onChanged: (v) {
